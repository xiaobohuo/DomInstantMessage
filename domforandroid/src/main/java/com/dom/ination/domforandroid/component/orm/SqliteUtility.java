package com.dom.ination.domforandroid.component.orm;
...
import com.dom.ination.domforandroid.component.orm.extra.AutoIncrementTableColumn;
import com.dom.ination.domforandroid.component.orm.extra.Extra;
import com.dom.ination.domforandroid.component.orm.extra.TableColumn;
import com.dom.ination.domforandroid.component.orm.extra.TableInfo;
import com.dom.ination.domforandroid.component.orm.utils.SqlUtils;
import com.dom.ination.domforandroid.component.orm.utils.TableInfoUtils;
 ...
 * 面向对象的数据库操作帮助类，支持App内部、Sdcard建库，dbName表示不同的库
 * DB版本升级，即version发生升级的时候，默认清空数据库
 * DB版本不变，Class字段增加字段时，Table会自动增加相对应的一列，Sqlite不支持Table的自动删除操作
 */
...
public class SqliteUtility {
    ...
    // 检查table是否已经存在 不存在，就自动创建 存在，检查Entity字段是否有增加，有则更新表
